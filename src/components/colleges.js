...
const Colleges = ({ date, count, time }) => {
  ...
  useEffect(() => {
    var array = [
      "CHANCELLOR OF CAL CAROL CHRIST",
      "PRES OF STANFORD MARC TESSIER-LAVIGNE",
      "CHANCELOR OF UCLA GENE BLOCK",
      "PRES. OF PRINCETON CHRISTINA PAXSON",
      "PRES. OF HARVARD LAWRENCE BACOW",
      " PRES. OF USC CAROL FOLT",
      "PRES. OF YALE PETER SALOVEY",
      "PRES. OF PENN AMY GUTMANN",
      "PRES. OF CORNELL MARTHA POLLACK",
      "PRES. OF DARTMOUTH PHILIP HANLON",
      "PRES. OF COLUMBIA LEE BOLINGER",
    ];
        ...
        <div className="Confirm-container">
          ...
          <div className="Confirm">
            ...
            <div className="Confirm-2">
              <div className="Confirm-text">
                {" "}
                SENT TO: STANFORD, BERKELEY, UCLA, USC, MIT & EVERY IVY{" "}
              </div>
              <div className="Confirm-text">
                {" "}
                STATUS: ALL FAXES DELIVERED WITHIN 48H
              </div>
            </div>
            ...
            <div className="Faxed-share">
              SHARE WITH YOUR FRIENDS TO GET TO 1 MILLION FAXES!
            </div>

            {timer > 12 && <ShareButton></ShareButton>}
          </div>
