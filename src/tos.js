...
const Tos = ( {image, caption, color} ) => {
    return(
        ...
        <Title text = "Terms of Service"></Title>
        <Line text = "Last Updated: November 3, 2020 "
        ></Line>

        <Paragraph text = 'These terms of service ("Terms") apply to your access and use of Teach (the "Service"). Please read them carefully.'
        ></Paragraph>

        <Paragraph text = 'Accepting these Terms If you access or use the Service, it means you agree to be bound by all of the terms below. So, before you use the Service, please read all of the terms. If you do not agree to all of the terms below, please do not use the Service. Also, if a term does not make sense to you, please let us know by e-mailing irissuggestions@gmail.com.'
        ></Paragraph>

        <Paragraph text = 'Changes to these Terms We reserve the right to modify these Terms at any time. For instance, we may need to change these Terms if we come out with a new feature or for some other reason'
        ></Paragraph>
        ...
        <Paragraph text = " 
            ...
            These terms of service ('Terms') apply to your access and use of Teach (the 'Service'). Please read them carefully.
            
            -- Accepting these Terms
            If you access or use the Service, it means you agree to be bound by all of the terms below. So, before you use the Service, please read all of the terms. If you do not agree to all of the terms below, please do not use the Service. Also, if a term does not make sense to you, please let us know by e-mailing irissuggestions@gmail.com.
            ...
            -- Privacy Policy
            For information about how we collect and use information about users of the Service, please check out our privacy policy available from the settings page of Teach.
            ...
            Teach makes no claim or representation regarding, and accepts no responsibility for third party websites accessible by hyperlink from the Service or websites linking to the Service. When you leave the Service, you should be aware that these Terms and our policies no longer govern.
            ...
            IN NO EVENT WILL TEACH BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY SPECIAL, INDIRECT, INCIDENTAL, EXEMPLARY OR CONSEQUENTIAL DAMAGES OF ANY KIND ARISING OUT OF OR IN CONNECTION WITH THE SERVICE OR ANY OTHER SERVICE AND/OR CONTENT INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SERVICE, REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR ARE AWARE OF THE POSSIBILITY OF SUCH DAMAGES. OUR TOTAL LIABILITY FOR ALL CAUSES OF ACTION AND UNDER ALL THEORIES OF LIABILITY WILL BE LIMITED TO THE AMOUNT YOU PAID TO IRIS. THIS SECTION WILL BE GIVEN FULL EFFECT EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS DEEMED TO HAVE FAILED OF ITS ESSENTIAL PURPOSE.
            ...
            -- Entire Agreement --
            These Terms constitute the entire agreement between you and Teach regarding the use of the Service, superseding any prior agreements between you and Teach relating to your use of the Service.
            
            -- Feedback --
            Please let us know what you think of the Service, these Terms and, in general, Teach. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, Teach, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.
