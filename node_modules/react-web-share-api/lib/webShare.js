...
exports.share = function (config) { return function () {
    return navigator.share(config.params)
        .then(config.onShareSuccess)
        .catch(config.onShareError);
}; };
var paymentRequest = function () { return function (WrappedComponent) { return ((function (_super) {
    ...
    ExtendedComponent.prototype.render = function () {
        ...
        var isSupported = navigator.share !== undefined;
        var supportedProps = isSupported && config
            ? { isSupported: isSupported, share: exports.share(config) }
